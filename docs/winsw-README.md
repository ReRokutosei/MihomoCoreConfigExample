> From https://github.com/winsw/winsw/blob/v3/README.md
>
> Commits on Jan 30, 2023 e4cf507bae5981363a9cdc0f7301c1aa892af401
...
1. Write *myapp.xml* (see the [XML config file specification](winsw-xml-config-file.md) and [samples](samples) for more details).
...
The full specification of the configuration file is available [here](winsw-xml-config-file.md).
You can find more samples [here](samples).

## Usage

WinSW is being managed by the [XML configuration file](winsw-xml-config-file.md).
...
* Configuration:
  * [XML configuration file](winsw-xml-config-file.md)
